...
class SingleNonRatingGameRepository {
  ...
  Future<void> saveUserHints(Map<int, List<List<int>>> hints) async {
    await sharedPreferences.setString(
      SharedPreferencesConstants.userHintsKey,
      jsonEncode(_mapToJson(hints)),
    );
  }
  ...
  Map<int, List<List<int>>> loadUserHints() {
    var str =
        sharedPreferences.getString(SharedPreferencesConstants.userHintsKey);
    return (jsonDecode(str) as Map).map((key, value) => MapEntry(int.parse(key),
        (value as List).map((e) => (e as List).cast<int>()).toList()));
  }
  ...
  Future<void> clearSavedData() async {
    var futures = [
      ...
      sharedPreferences.remove(SharedPreferencesConstants.userHintsKey),
  ...
  bool get isSaveAvailable {
    return sharedPreferences
        ...
        sharedPreferences.containsKey(SharedPreferencesConstants.userHintsKey);
  }
